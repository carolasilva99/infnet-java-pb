...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" href="${pageContext.request.contextPath}/candidatos/consulta-vagas.jsp">
    ...
    <!-- Nav Item - Pages Collapse Menu -->
    <li class="nav-item">
<%--        <form method="get" action="${pageContext.request.contextPath}/consulta-candidatura">--%>
<%--            <button type="submit" class="nav-link"><i class="fas fa-fw fa-search"></i>--%>
