  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <div class="container align-content-center justify-content-center text-center">
        ...
        <form method="post" action="${pageContext.request.contextPath}/consulta-vaga"  class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" >
