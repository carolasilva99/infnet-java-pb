                    ...
                    <div class="p-5">
                        ...
                        <form action="${pageContext.request.contextPath}/cadastro-empresa" method="post" class="user">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input type="text" class="form-control form-control-user" id="cnpj" name="cnpj"
                                           placeholder="CNPJ">
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <hr>
                        <div class="text-center">
                            <a class="small" href="${pageContext.request.contextPath}/login.jsp">Já tem uma conta? Login!</a>
                        </div>
                    </div>
                </div>
            </div>
